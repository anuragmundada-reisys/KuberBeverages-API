...
public class OrdersService {
    ...
    private static final String INSERT_ORDER = "INSERT INTO Orders(Customer_Name, Status, Date) VALUES ( :customerName, :status, :orderDate)";
    private static final String INSERT_ORDER_DETAILS = "INSERT INTO Order_Details(Order_Id, Product_Id, Quantity) VALUES ( :orderId, :productId, :quantity)";
    private static final String GET_LAST_INSERTED_ORDER_ID = "SELECT LAST_INSERT_ID()";

    private static final String GET_ORDERS = "Select orders.*, JSON_ARRAYAGG(JSON_OBJECT('orderDetailsId', od.Order_Details_Id, 'productId', od.Product_Id , 'quantity', od.Quantity, 'productType', p.Product_Type )) as orders " +
    ...
    private static final String UPDATE_ORDER = "UPDATE Orders set Status=:status where Order_Id=:orderId";
    private static final String UPDATE_ORDER_DETAILS = "UPDATE Order_Details set Product_Id=:productId, Quantity=:quantity where Order_Details_Id=:orderDetailsId";
